...
def generate_raster_outlines_shapefile(raster_dir, shapefile_path):
    """
    ...
    shp_path = os.path.join(shapefile_path, f"outlines.shp")
    gdf.to_file("D:/ESA_LC/raster_outlines.shp", driver="ESRI Shapefile")

    print(f"Shapefile saved to {shapefile_path}")


if __name__ == "__main__":
    # Define the input raster directory and output shapefile path
    raster_dir = "D:/ESA_LC"  # Replace with your raster directory
    shapefile_path = "D:/ESA_LC/raster_outlines"  # Replace with your desired shapefile path

    generate_raster_outlines_shapefile(raster_dir, shapefile_path)
