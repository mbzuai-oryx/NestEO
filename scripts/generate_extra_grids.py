...
def main(config_file="extra_grid_config.yaml"):
    ...
    grid = HenarcmeoGrid(
        ...
        chunked_levels=config.get("chunked_levels", [300]),
...
if __name__ == "__main__":
    import sys
    config_arg = sys.argv[1] if len(sys.argv) > 1 else "extra_grid_config.yaml"
